    ...
    public function run()
    {
	    ...
	    DB::table('events')->insert([
		    [
			    ...
			    "kpi" => '[{"text":"Edukasi & Trial","short_text":"Edu","field":"education","values":["data_rollover","stream_on","kuota_bonus_4g"],"type":"require_multiple","goal":30,"unit":"orang","report_unit":1,"required":""},{"text":"Share Moment","short_text":"SM","field":"moment","values":["twitter","facebook","instagram"],"type":"require_one_field","goal":10,"unit":"orang","report_unit":1,"required":"education"},{"text":"SP","short_text":"SP","field":"sales.number","type":"count","goal":10,"unit":"pcs","report_unit":1,"required":""},{"text":"Add-On","short_text":"Add-On","field":"sales.package","type":"price","goal":100000,"unit":"","report_unit":10000,"required":""}]',
